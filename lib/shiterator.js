...
Shiterator.prototype.listen = function() {
    var port = (arguments[0] !== undefined ? arguments[0] : this.options.port) || 3000,
        host = arguments[1] !== undefined ? arguments[1] : this.options.host;

    console.log('Shiterator started on ' + host + ':' + port);
